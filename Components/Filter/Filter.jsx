...
import { MdOutlinePersonalVideo, MdVerified } from 'react-icons/md'
      ...
      </div>
      {
        filter &&  (
          <div className={Style.filter_box_items}>
            <div className={Style.folter_box_items_box}>
              <div className={Style.filter_box_items_box_item}>
                <FaWallet/> <span>0.01 ETH - 10ETH</span>
                <AiFillCloseCircle />
              </div>
            </div>
            ...
            <div className={Style.filter_box_items_box}>
                <div className={Style.filter_bbox_items_box_item}>
